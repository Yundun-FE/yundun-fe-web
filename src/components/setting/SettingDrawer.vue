      ...
      <div class="setting-drawer-index-content">
            ...
            <a-list :split="false">
              <a-list-item>
                <a-tooltip slot="actions">
                  ...
                  <a-select :default-value="contentWidth" size="small" style="width: 80px;" @change="handleContentWidthChange">
              ...
              <a-list-item>
                <a-switch slot="actions" :default-checked="fixedHeader" size="small" @change="handleFixedHeader" />
                <a-list-item-meta>
                  <div slot="title">固定 Header</div>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item>
                <a-switch slot="actions" :disabled="!fixedHeader" :default-checked="autoHideHeader" size="small" @change="handleFixedHeaderHidden" />
                <a-list-item-meta>
                  <div slot="title" :style="{ textDecoration: !fixedHeader ? 'line-through' : 'unset' }">下滑时隐藏 Header</div>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item >
                <a-switch slot="actions" :disabled="(layoutMode === 'topmenu')" :default-checked="fixSiderbar" size="small" @change="handleFixSiderbar" />
                <a-list-item-meta>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div>
            <a-list :split="false">
              <a-list-item>
                <a-switch slot="actions" :default-checked="colorWeak" size="small" @change="onColorWeak" />
                <a-list-item-meta>
                  <div slot="title">色弱模式</div>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item>
                <a-switch slot="actions" :default-checked="multiTab" size="small" @change="onMultiTab" />
                <a-list-item-meta>
